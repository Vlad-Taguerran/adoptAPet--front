...
export function FormComponet() {
  ...
  return (
    <Box component="form" onSubmit={formik.handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <TextField name="name" id="petName" type="string" margin="dense"
       label ="Nome"
...
<TextField name="description" id="description" type="string" margin="dense"
       label ="Descrição"
     ...
     <Button fullWidth={true}  type="submit" >Salvar</Button>
  </Box>
)
}
